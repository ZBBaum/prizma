    ...
    <footer className="bg-white dark:bg-[#0a0a0a] transition-colors duration-300">
      ...
      <div className="max-w-5xl mx-auto px-6 py-8 flex items-center justify-between">
        ...
        <div className="flex items-center gap-6">
          <Link href="/about" className="text-sm font-medium text-black/40 dark:text-white/40 hover:text-black/70 dark:hover:text-white/70 transition-colors">
            About
          </Link>
          <Link href="/built" className="text-sm font-medium text-black/40 dark:text-white/40 hover:text-black/70 dark:hover:text-white/70 transition-colors">
            Work
          </Link>
          <Link href="/contact" className="text-sm font-medium text-black/40 dark:text-white/40 hover:text-black/70 dark:hover:text-white/70 transition-colors">
            Contact
          </Link>
          <a

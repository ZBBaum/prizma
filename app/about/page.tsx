  ...
  return (
    <>
      <section className="max-w-5xl mx-auto px-6 pt-28 pb-20">
        ...
        <p className="mt-8 text-lg font-semibold text-white/50 max-w-lg leading-relaxed">
      ...
      <section className="max-w-5xl mx-auto px-6 py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div>
            <h2 className="text-xs font-bold tracking-widest uppercase text-white/30 mb-6">
              Our mission
            </h2>
          ...
          <div className="flex flex-col justify-center">
            <p className="text-sm font-semibold text-white/50 leading-relaxed mb-4">
      ...
      <section className="max-w-5xl mx-auto px-6 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          {values.map((v) => (
            <div key={v.title}>
              <h3 className="text-lg font-black mb-3 text-white">{v.title}</h3>
              <p className="text-sm font-semibold text-white/50 leading-relaxed">
                {v.description}
              </p>
            </div>

      ...
      <section className="max-w-5xl mx-auto px-6 py-20">
        {submitted ? (
          <div className="max-w-md">
            <h2 className="text-3xl font-black mb-4">Got it.</h2>
          ...
          <form onSubmit={handleSubmit} className="max-w-lg space-y-8">
            <div className="grid grid-cols-2 gap-6">
              <div className="flex flex-col gap-2">
                ...
                <input
                  ...
                  className="border border-black/15 px-4 py-3 text-sm font-semibold placeholder:text-black/25 focus:outline-none focus:border-black transition-colors bg-white"
                />
              </div>
              <div className="flex flex-col gap-2">
                <label className="text-xs font-bold tracking-widest uppercase text-black/40">
            ...
            <div className="flex flex-col gap-2">
              ...
              <textarea
                ...
                className="border border-black/15 px-4 py-3 text-sm font-semibold placeholder:text-black/25 focus:outline-none focus:border-black transition-colors resize-none bg-white"
              />
            </div>
